...
import net.rezolv.obsidanum.recipes.ForgeScrollNetherUpgradeRecipe;
import net.rezolv.obsidanum.recipes.ForgeScrollOrderUpgradeRecipe;
...
public class RightClickOrderPlanUp {
    ...
    public static void onRightClickItem(PlayerInteractEvent.RightClickItem event) {
        ...
        if (heldItem.getItem() != ItemsObs.UN_ORDER_SCROLL_UP.get() || level.isClientSide()) {
            return;
        }
        ...
        // Получаем рецепты
        List<ForgeScrollOrderUpgradeRecipe> recipes = level.getRecipeManager()
                .getAllRecipesFor(ForgeScrollOrderUpgradeRecipe.Type.FORGE_SCROLL_ORDER_UPGRADE);
        ...
        ForgeScrollOrderUpgradeRecipe randomRecipe = recipes.get(RANDOM.nextInt(recipes.size()));
        ItemStack planItem = new ItemStack(ItemsObs.ORDER_UPGRADE_PLAN.get());
