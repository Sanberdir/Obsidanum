...
public class RightClickNetherPlanUp {
    ...
    public static void onRightClickItem(PlayerInteractEvent.RightClickItem event) {
        ...
        if (heldItem.getItem() != ItemsObs.UN_NETHER_SCROLL_UP.get() || level.isClientSide()) {
            return;
        }
        ...
        // Получаем рецепты
        List<ForgeScrollNetherUpgradeRecipe> recipes = level.getRecipeManager()
                .getAllRecipesFor(ForgeScrollNetherUpgradeRecipe.Type.FORGE_SCROLL_NETHER_UPGRADE);
        ...
        ForgeScrollNetherUpgradeRecipe randomRecipe = recipes.get(RANDOM.nextInt(recipes.size()));
        ItemStack planItem = new ItemStack(ItemsObs.NETHER_UPGRADE_PLAN.get());
