...
@OnlyIn(Dist.CLIENT)
public class GlintCrimson extends SimpleAnimatedParticle {
    GlintCrimson(ClientLevel p_106531_, double p_106532_, double p_106533_, double p_106534_, double p_106535_, double p_106536_, double p_106537_, SpriteSet p_106538_) {
        super(p_106531_, p_106532_, p_106533_, p_106534_, p_106538_, 0.0125F);
        this.xd = p_106535_ * 0.2; // Уменьшаем разлет по X
        this.yd = p_106536_ * 0.2; // Уменьшаем разлет по Y
        this.zd = p_106537_ * 0.2; // Уменьшаем разлет по Z
        this.quadSize *= 0.75F;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_106566_, ClientLevel p_106567_, double p_106568_, double p_106569_, double p_106570_, double p_106571_, double p_106572_, double p_106573_) {
            return new GlintCrimson(p_106567_, p_106568_, p_106569_, p_106570_, p_106571_, p_106572_, p_106573_, this.sprites);
        }
    }
}
