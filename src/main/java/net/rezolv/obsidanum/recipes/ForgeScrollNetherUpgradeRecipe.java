...
public class ForgeScrollNetherUpgradeRecipe implements Recipe<SimpleContainer> {
    ...
    public ForgeScrollNetherUpgradeRecipe(NonNullList<Ingredient> ingredients,
    ...
    public RecipeSerializer<?> getSerializer() {
        return Serializer.FORGE_SCROLL_NETHER_UPGRADE;
    }

    @Override
    public RecipeType<?> getType() {
        return Type.FORGE_SCROLL_NETHER_UPGRADE;
    }

    public static class Type implements RecipeType<ForgeScrollNetherUpgradeRecipe> {
        public static final Type FORGE_SCROLL_NETHER_UPGRADE = new Type();
        public static final String ID = "scrolls/forge_scroll_nether_up";
    }

    public static class Serializer implements RecipeSerializer<ForgeScrollNetherUpgradeRecipe> {
        public static final Serializer FORGE_SCROLL_NETHER_UPGRADE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(Obsidanum.MOD_ID, "scrolls/forge_scroll_nether_up");

        @Override
        public ForgeScrollNetherUpgradeRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new ForgeScrollNetherUpgradeRecipe(ingredients, ingredientJsons, upgrade, recipeId, requiredScrolls);
        }

        @Nullable
        @Override
        public ForgeScrollNetherUpgradeRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, ForgeScrollNetherUpgradeRecipe recipe) {
