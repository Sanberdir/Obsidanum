...
public class ForgeScrollOrderUpgradeRecipe implements Recipe<SimpleContainer> {
    ...
    public ForgeScrollOrderUpgradeRecipe(NonNullList<Ingredient> ingredients,
    ...
    public RecipeSerializer<?> getSerializer() {
        return Serializer.FORGE_SCROLL_ORDER_UPGRADE;
    }

    @Override
    public RecipeType<?> getType() {
        return Type.FORGE_SCROLL_ORDER_UPGRADE;
    }

    public static class Type implements RecipeType<ForgeScrollOrderUpgradeRecipe> {
        public static final Type FORGE_SCROLL_ORDER_UPGRADE = new Type();
        public static final String ID = "scrolls/forge_scroll_order_up";
    }

    public static class Serializer implements RecipeSerializer<ForgeScrollOrderUpgradeRecipe> {
        public static final Serializer FORGE_SCROLL_ORDER_UPGRADE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(Obsidanum.MOD_ID, "scrolls/forge_scroll_order_up");

        @Override
        public ForgeScrollOrderUpgradeRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new ForgeScrollOrderUpgradeRecipe(ingredients, ingredientJsons, upgrade, recipeId, requiredScrolls);
        }

        @Nullable
        @Override
        public ForgeScrollOrderUpgradeRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, ForgeScrollOrderUpgradeRecipe recipe) {
