...
public class ForgeScrollCatacombsUpgradeRecipe implements Recipe<SimpleContainer> {
    ...
    public ForgeScrollCatacombsUpgradeRecipe(NonNullList<Ingredient> ingredients,
    ...
    public RecipeSerializer<?> getSerializer() {
        return Serializer.FORGE_SCROLL_CATACOMBS_UPGRADE;
    }

    @Override
    public RecipeType<?> getType() {
        return Type.FORGE_SCROLL_CATACOMBS_UPGRADE;
    }

    public static class Type implements RecipeType<ForgeScrollCatacombsUpgradeRecipe> {
        public static final Type FORGE_SCROLL_CATACOMBS_UPGRADE = new Type();
        public static final String ID = "scrolls/forge_scroll_catacombs_up";
    }

    public static class Serializer implements RecipeSerializer<ForgeScrollCatacombsUpgradeRecipe> {
        public static final Serializer FORGE_SCROLL_CATACOMBS_UPGRADE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(Obsidanum.MOD_ID, "scrolls/forge_scroll_catacombs_up");

        @Override
        public ForgeScrollCatacombsUpgradeRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new ForgeScrollCatacombsUpgradeRecipe(ingredients, ingredientJsons, upgrade, recipeId, requiredScrolls);
        }

        @Nullable
        @Override
        public ForgeScrollCatacombsUpgradeRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, ForgeScrollCatacombsUpgradeRecipe recipe) {
