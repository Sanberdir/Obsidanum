...
import net.rezolv.obsidanum.gui.forge_crucible.destruction_render.ForgeCrucibleDestructionScreen;
...
public class ObsidanumScreens {
    ...
    public static void clientLoad(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(ObsidanumMenus.FORGE_CRUCIBLE_GUI_DESTRUCTION.get(), ForgeCrucibleDestructionScreen::new);
        });
    }
}
